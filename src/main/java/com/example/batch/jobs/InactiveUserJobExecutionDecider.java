 ...
 * 조건에 따라 JobStep 을 실행 시키도록 하기 위해 InactiveUserJobExecutionDecider 클래스를 구현 하도록 한다.
 *
 * FlowExecutionStatus 객체는 상태값 completed,stopped,failed,unknown 등을 제공한다.
 */
@Slf4j
public class InactiveUserJobExecutionDecider implements org.springframework.batch.core.job.flow.JobExecutionDecider {
